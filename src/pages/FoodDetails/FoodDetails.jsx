...
import { FaArrowLeft, FaTags, FaBox, FaCalendarAlt, FaStickyNote } from 'react-icons/fa';
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-base-300 shadow rounded-lg overflow-hidden">
                    ...
                    <div className="p-5">
                        ...
                        <p className="flex items-center text-sm mb-2">
                            ...
                            <span className="text-red-600 font-semibold">{foodData.expiryDate}</span>
                        </p>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-base-300 shadow rounded-lg p-5">
                        ...
                        {isExpired ? (
                            <div className="text-center text-red-600 font-bold text-2xl">EXPIRED</div>
                        ) : (
                    ...
                    <div className="bg-base-300 shadow rounded-lg p-5">
                        ...
                        {Array.isArray(foodData.notes) && foodData.notes.length > 0 ? (
                            foodData.notes.map((note, index) => (
                                <div
                                    key={index}
                        ...
                        <textarea
                            placeholder={
                                user ? 'Write a note about this item...' : 'Please log in to add notes'
                            }
                        ...
                        {!user && (
                            <p className="text-center text-sm text-blue-600 mt-2">
                                Log in to add notes and track this item.
                            </p>
                        )}
                    </div>
                </div>
