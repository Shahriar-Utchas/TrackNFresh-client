...
const Registration = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-base-300 px-4 py-4">
        <div className="flex flex-col md:flex-row-reverse bg-base-100 shadow-2xl rounded-2xl overflow-hidden w-full max-w-4xl">

          {/* Lottie animation */}
          <div className="w-full md:w-[40%] flex items-center justify-center bg-info-content p-6 md:p-10">
            <Lottie animationData={registrationAnimation} loop style={{ width: '100%', maxWidth: 400, height: 'auto' }} />
          </div>

          {/* Registration form */}
          <div className="w-full md:w-[60%] p-6 md:p-10">
            <div className="mb-6 md:mb-8 text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-dark mb-2">Create an Account</h2>
            ...
            <p className="mt-4 md:mt-6 text-center text-sm">
